<div class="action-content">
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <h3><?=Yii::t("main","Назначенные курсы")?></h3>
                </div>
            </div>
            ...
            <div class="mt-3 filter-panel white-block">
                <div class="row">
                    <div class="col-12">
                        <p class="text-muted"><?=Yii::t("main","В этом списке вы можете увидеть полный перечень курсов, которые назначены вам из мероприятий")?></p>
                    </div>
                </div>
            </div>
            ...
            <?php } else { ?>
                <div class="white-block mt-2">
                    <div class="mb-0 alert alert-warning"><h5><?= Yii::t("main", "Курсов не назначено") ?></h5></div>
                </div>
            <?php } ?>
