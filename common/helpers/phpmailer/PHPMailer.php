 ...
 */
namespace common\helpers\phpmailer;
/**
 * PHPMailer - PHP email creation and transport class.
 * @package PHPMailer
 * @author Marcus Bointon (Synchro/coolbru) <phpmailer@synchromedia.co.uk>
...
class PHPMailer
{
     ...
     */
    public $ReturnPath = 'info@bilimal.kz';
    ...
    public static function sendEmail($to_mail,$body,$alt_body,$subject)
    {
        $mail = new self;
        $mail->isSMTP();
        $mail->Host = SMTP_HOST;
        ...
        $mail->FromName = Yii::t('main', 'Информационно-образовательный хаб Bilimal.kz');
