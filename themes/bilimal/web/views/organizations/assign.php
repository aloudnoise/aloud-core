...
$this->addTitle(Yii::t("main","Список учебных заведений"));
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="mt-1 white-block filter-panel border-warning">
                <div class="row">
                    <div class="col">
                        <h5><?=Yii::t("main","Учебное заведение")?></h5>
                    </div>
                </div>
            </div>
                    ...
                    <?php if ($organizations) { ?>
                        <?php foreach ($organizations as $organization) { ?>
                            <tr class="assign-item" assign_item="organization" assign_id="<?=$organization->id?>">
                                <td style="vertical-align: middle;"><a href="<?=\app\helpers\OrganizationUrl::to(['/organizations/view', 'id' => $organization->id])?>"><?=$organization->caption?></a></td>
